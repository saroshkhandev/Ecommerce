...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
        ...
        merchant_id="rbvzb8fzv6hpdt5n",
        public_key="zxb7vdj5s69scz6d",
        private_key="3da4b936a190f4083900a58a1f74bda0"
    )
)
...
def generate_token(request, id, token):
    if not validate_user_session(id, token):
        return JsonResponse({'error': 'Invalid Login Session, Login again.'})
